...
Write-Host "  pytest tests/unit/ -v" -ForegroundColor White
Write-Host "  pytest tests/integration/infrastructure/test_mongodb_data_quality.py -v" -ForegroundColor White
