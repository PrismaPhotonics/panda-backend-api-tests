# הוספת טסטי Alerts לתיקיות Xray - הוראות מלאות
...
צור את התיקיות הבאות בתיקיית הבסיס (`68d91b9f681e183ea2e83e16`):
...
### שלב 3: הוספת טסטים לכל תיקייה

לכל קטגוריה, בצע:

1. **פתח את התיקייה**
2. **השתמש ב-JQL Query** (ראה למטה)
