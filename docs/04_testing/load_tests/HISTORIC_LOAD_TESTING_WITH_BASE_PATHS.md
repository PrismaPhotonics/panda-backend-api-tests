...
## 🎯 עקרונות עומס בחקירות היסטוריות

### מתי נוצר עומס?

**עומס בחקירות היסטוריות יקרה רק כשיהיו הרבה חקירות פעילות במקביל.**

- **חקירה פעילה** = חקירה שעדיין מעבדת דאטא
- ככל שיש יותר חקירות פעילות במקביל, כך העומס על המערכת גדל
- לכן, כדי ליצור עומס אמיתי, צריך ליצור הרבה חקירות במקביל

### משך זמן החקירה

**פרק זמן ארוך יותר מאפשר שהחקירה תרוץ יותר זמן.**

- חקירה עם פרק זמן ארוך יותר תעבד יותר דאטא
- זה מאפשר לחקירה להישאר פעילה זמן רב יותר
- לכן, כדי ליצור עומס ממושך, צריך להשתמש בפרקי זמן ארוכים יותר

### מגבלת פרק זמן לפי גודל החלון

**יש מגבלה על פרק זמן לפי גודל החלון - עד 30 חלונות.**

הנוסחה: `משך זמן מקסימלי = גודל החלון × 30`

**דוגמאות:**
- אם גודל החלון הוא **30 שניות** → משך זמן מקסימלי = 30 × 30 = **900 שניות (15 דקות)**
- אם גודל החלון הוא **דקה** → משך זמן מקסימלי = 60 × 30 = **1800 שניות (30 דקות)**
- אם גודל החלון הוא **יום** → משך זמן מקסימלי = 86400 × 30 = **2,592,000 שניות (30 יום)**

**הערה:** גודל החלון נקבע על ידי `displayTimeAxisDuration` בקונפיגורציה.

### קצב עיבוד

**יש התחייבות לקצב מסוים (כנראה פי 200 מזמן אמת).**

- המערכת מתחייבת לעבד דאטא היסטורי בקצב מהיר יותר מזמן אמת
- הקצב המדויק עדיין לא מאומת (צריך לבדוק)
- זה משפיע על כמה זמן תרוץ חקירה עם פרק זמן מסוים

### השלכות לאוטומציה

כדי ליצור load test אפקטיבי לחקירות היסטוריות:

1. **ליצור הרבה חקירות במקביל** - כדי ליצור עומס אמיתי
2. **להשתמש בפרקי זמן ארוכים** - כדי שהחקירות יישארו פעילות זמן רב יותר
3. **לכבד את מגבלת 30 החלונות** - לא לנסות ליצור חקירה עם פרק זמן גדול מדי
4. **לחשב את משך הזמן המקסימלי** - לפי גודל החלון: `משך זמן מקסימלי = displayTimeAxisDuration × 30`
...
| `displayTimeAxisDuration` | 10 | גודל החלון (שניות) - משפיע על מגבלת פרק הזמן |

### מגבלות פרק זמן

| גודל החלון (`displayTimeAxisDuration`) | משך זמן מקסימלי | הערות |
|------------------------------------------|-----------------|-------|
| 30 שניות | 15 דקות (900 שניות) | 30 × 30 = 900 שניות |
| 60 שניות (דקה) | 30 דקות (1800 שניות) | 60 × 30 = 1800 שניות |
| 300 שניות (5 דקות) | 150 דקות (2.5 שעות) | 300 × 30 = 9000 שניות |
| 3600 שניות (שעה) | 30 שעות | 3600 × 30 = 108,000 שניות |
| 86400 שניות (יום) | 30 יום | 86400 × 30 = 2,592,000 שניות |

**חשוב:** לא לנסות ליצור חקירה עם `end_time - start_time` גדול מ-`displayTimeAxisDuration × 30`.
...
6. **מגבלת 30 חלונות** - לא ליצור חקירה עם פרק זמן גדול מ-`displayTimeAxisDuration × 30`
7. **עומס אמיתי** - עומס יקרה רק כשיש הרבה חקירות פעילות במקביל
8. **פרק זמן ארוך** - פרק זמן ארוך יותר מאפשר שהחקירה תרוץ יותר זמן ותישאר פעילה
