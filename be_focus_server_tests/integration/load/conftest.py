"""
Pytest Configuration for Load and Performance Tests
====================================================

Fixtures and configuration specific to load and performance testing,
...
def auto_cleanup_jobs(focus_server_api, request):
    """
    Automatic cleanup fixture for load and performance tests with system cleanup verification.
