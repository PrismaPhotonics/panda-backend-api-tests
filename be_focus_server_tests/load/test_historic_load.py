...
@pytest.fixture
def historic_tester(config_manager):
    """Create Historic Job Load Tester."""
    from be_focus_server_tests.load.job_load_tester import create_historic_job_tester
    
    return create_historic_job_tester(
...
@pytest.fixture
def heavy_historic_tester(config_manager):
    """Create heavy Historic Job Load Tester."""
    from be_focus_server_tests.load.job_load_tester import create_historic_job_tester
