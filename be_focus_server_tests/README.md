...
### By Functionality
- **MongoDB:** `be_focus_server_tests/data_quality/` + `be_focus_server_tests/infrastructure/test_mongodb_*.py` + `be_focus_server_tests/integration/data_quality/`
- **API Endpoints:** `be_focus_server_tests/integration/api/`
- **ROI:** `be_focus_server_tests/integration/api/test_dynamic_roi_adjustment.py`
- **SingleChannel:** `be_focus_server_tests/integration/api/test_singlechannel_view_mapping.py`
- **Waterfall:** `be_focus_server_tests/integration/api/test_waterfall_*.py`
- **Historic:** `be_focus_server_tests/integration/api/test_historic_playback_*.py`
- **Live:** `be_focus_server_tests/integration/api/test_live_monitoring_flow.py`
- **Connectivity:** `be_focus_server_tests/infrastructure/test_*_connectivity.py`
- **Resilience:** `be_focus_server_tests/infrastructure/resilience/`
- **Error Handling:** `be_focus_server_tests/integration/error_handling/`
- **Load:** `be_focus_server_tests/integration/load/` + `be_focus_server_tests/load/`
- **Performance:** `be_focus_server_tests/integration/performance/` + `be_focus_server_tests/performance/`
- **Security:** `be_focus_server_tests/integration/security/` + `be_focus_server_tests/security/`

### By Jira Ticket
All tests are marked with `@pytest.mark.xray()` for Jira integration. See individual test files for ticket mappings.

**Key Jira Tickets:**
- PZ-13986 (200 Jobs Capacity) → `be_focus_server_tests/load/test_job_capacity_limits.py`
- PZ-13985 (Live Metadata Missing Fields) → `be_focus_server_tests/integration/api/test_live_monitoring_flow.py`
- PZ-13984 (Future Timestamps Accepted) → `be_focus_server_tests/integration/api/test_prelaunch_validations.py`
- PZ-13983 (MongoDB Indexes Missing) → `be_focus_server_tests/data_quality/test_mongodb_indexes_and_schema.py`
- PZ-13669 (SingleChannel min!=max) → `be_focus_server_tests/integration/api/test_singlechannel_view_mapping.py`
- PZ-13640 (Slow MongoDB Outage Response) → `be_focus_server_tests/performance/test_mongodb_outage_resilience.py`
- PZ-13238 (Waterfall Fails) → `be_focus_server_tests/integration/api/test_waterfall_view.py`
...
- `be_focus_server_tests/conftest.py` - Pytest configuration and fixtures
- `be_focus_server_tests/conftest_xray.py` - Xray integration configuration
- `be_focus_server_tests/pytest_logging_plugin.py` - Automatic test logging
